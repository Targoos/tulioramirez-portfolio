      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-44 right-4 md:bottom-24 md:right-6 z-50 w-[calc(100%-2rem)] sm:w-96 flex flex-col bg-surface border border-outline-variant/30 shadow-[4px_4px_0px_#E8FF47]"
